...
export function OptimizedImage({
  ...
  const imageProps = {
    ...
    // Maintain aspect ratio when CSS modifies image size by letting the browser
    // freely calculate both dimensions from the intrinsic ratio (fixes Next.js warning)
